...
import { Upload, CheckCircle, Clock, Shield, Users, ShoppingBag, DollarSign, ArrowRight, FileText, Star, Zap } from "lucide-react";
    ...
    <section id="how-it-works" className="py-24">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-lg mx-auto">Three simple steps to get your assignments done by verified campus agents.</p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          {steps.map((step, i) => (
            <div key={i} className="relative text-center group">
              ...
              <span className="absolute -top-2 -right-2 md:right-auto md:-left-2 w-7 h-7 rounded-full bg-primary text-primary-foreground text-xs font-bold flex items-center justify-center">
                {i + 1}
              </span>
...
const FeaturesSection = () => {
  const features = [
    { icon: Shield, title: "Verified Agents", desc: "Every agent is vetted with ID, sample work, and trial tasks before approval." },
    { icon: Clock, title: "Deadline Guaranteed", desc: "Set your deadline and get timely delivery — or your money back." },
    { icon: Zap, title: "Escrow Payments", desc: "Funds are held securely until you approve the deliverable." },
    ...
    { icon: DollarSign, title: "Earn Money", desc: "Become an agent or explore curated earning opportunities." },
  ];
  ...
  <section id="store" className="py-24">
    <div className="container mx-auto px-4 text-center">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
        {["Notebooks", "Pens & Markers", "Lab Coats", "Calculators"].map((item, i) => (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="card-hover rounded-xl border border-border bg-card p-8 text-left" style={{ boxShadow: "var(--card-shadow)" }}>
            ...
            <p className="text-sm text-muted-foreground mb-4 leading-relaxed">
              Get verified, accept assignments for your class, and earn on your schedule.
            </p>
          ...
          <div className="card-hover rounded-xl border border-border bg-card p-8 text-left" style={{ boxShadow: "var(--card-shadow)" }}>
            ...
            <p className="text-sm text-muted-foreground mb-4 leading-relaxed">
              Curated, vetted opportunities to make money as a student — no scams.
            </p>
            <Button variant="outline" size="sm">Explore <ArrowRight className="ml-1 h-3 w-3" /></Button>
          </div>
        </div>
      </div>
    </div>
